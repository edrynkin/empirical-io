...
import numpy as np
import scipy.stats
from basic_demand_estimation import berry_inversion_vd, shares_vd, berry_estimator_vd, vd_d_to_shares, vd_shares_to_d

""""
How to run?
% python -m unittest test_vertical_differentiation
"""
